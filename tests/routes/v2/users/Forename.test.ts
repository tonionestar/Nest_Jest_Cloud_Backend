import {createNewUser, generateAccessToken, testForename} from "../../../classes/CommonTests";
...
describe(url, () => {
    ...
    describe("GET", () => {
        ...
        it("should not be possible to get forename when id is missing", async () => {
            const testUserId = await createNewUser({});
        ...
        it("should not be possible to get forename when id is wrong", async () => {
            const testUserId = await createNewUser({});
    ...
    describe("PUT", () => {
        ...
        it("should be possible to change forename", async () => {
            ...
            // check database
            const databaseResult = await db.GetForename(testUserId);
        ...
        it("should not be possible to change forename when id is missing", async () => {
            const testUserId = await createNewUser({});
